...
System.register(['app/plugins/sdk', 'lodash', 'app/core/utils/kbn', 'app/core/time_series', './rendering', './demos', './node_modules/snapsvg/dist/snap.svg-min.js', './node_modules/brace/index.js', './node_modules/brace/ext/language_tools.js', './node_modules/brace/theme/tomorrow_night_bright.js', './node_modules/brace/mode/javascript.js', './node_modules/brace/mode/svg.js', './handleMetric.js', './panel.js'], function (_export, _context) {
    ...
    return {
        ...
        }, function (_node_modulesBraceExtLanguage_toolsJs) {}, function (_node_modulesBraceThemeTomorrow_night_brightJs) {}, function (_node_modulesBraceModeJavascriptJs) {}, function (_node_modulesBraceModeSvgJs) {}, function (_handleMetricJs) {
            handleMetricCode = _handleMetricJs.handleMetricCode;
        }, function (_panelJs) {
            SVGPanelCode = _panelJs.SVGPanelCode;
        }],
        execute: function () {
            ...
            _export('SVGCtrl', SVGCtrl = function (_MetricsPanelCtrl) {
                ...
                function SVGCtrl($scope, $injector, $rootScope) {
                    ...
                    var panelDefaults = {
                        ...
                        svg_data: SVGPanelCode,
                        // svg_data: '<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 1000 1000" >' +
                        //     '<text font-size="80" x="110" y="100">Text</text>' +
                        //     '</svg>',
                        js_code: handleMetricCode,
                        js_init_code: handleMetricCode,
                        useSVGBuilder: false,
                        svgBuilderData: {
                            width: '100%',
                            height: '100%',
